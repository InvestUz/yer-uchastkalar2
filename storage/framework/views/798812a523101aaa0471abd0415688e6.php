            ...
            <nav class="flex-1 overflow-y-auto p-3">
                <div class="space-y-1">
                    ...
                    <a href="<?php echo e(route('yer-sotuvlar.index')); ?>"
                        ...
                        <span
                            class="nav-text text-sm font-medium <?php echo e(request()->routeIs('yer-sotuvlar.index') ? 'text-white' : 'text-gray-700'); ?>">Ер
                            мониторинг</span>
                    </a>
                    ...
                    <a href="<?php echo e(route('yer-sotuvlar.yigma')); ?>"
                        ...
                        <span
                            class="nav-text text-sm font-medium <?php echo e(request()->routeIs('yer-sotuvlar.yigma') ? 'text-white' : 'text-gray-700'); ?>">Тўлов
                            мониторинг</span>
                    </a>
                    <a href="<?php echo e(route('yer-sotuvlar.svod3')); ?>"
                        ...
                        <span
                            class="nav-text text-sm font-medium <?php echo e(request()->routeIs('yer-sotuvlar.svod3') ? 'text-white' : 'text-gray-700'); ?>">Бўлиб
                    ...
                    <a href="<?php echo e(route('yer-sotuvlar.fin-xisobot')); ?>"
                        class="nav-item flex items-center justify-between px-3 py-2.5 rounded-lg <?php echo e(request()->routeIs('yer-sotuvlar.fin-xisobot') ? 'active' : ''); ?>">
                        ...
                        <div class="flex items-center space-x-3">
                            ...
                            <span
                                class="nav-text text-sm font-medium <?php echo e(request()->routeIs('yer-sotuvlar.fin-xisobot') ? 'text-white' : 'text-gray-700'); ?>">
                                Молиявий Хисобот
                            </span>
                        </div>
            ...
            <div class="flex items-center justify-between">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-500">
                        <?php echo $__env->yieldContent('page_subtitle', 'Маълумотлар тизими'); ?>
                        <?php if($latestLotDate): ?>
                            <span class="text-emerald-600 font-medium">| Лот:
                                <?php echo e(\Carbon\Carbon::parse($latestLotDate)->format('d.m.Y')); ?></span>
                        <?php endif; ?>
                        <?php if($latestPaymentDate): ?>
                            <span class="text-blue-600 font-medium">| Тўлов:
                                <?php echo e(\Carbon\Carbon::parse($latestPaymentDate)->format('d.m.Y')); ?></span>
                        <?php endif; ?>
                    </p>
                </div>
