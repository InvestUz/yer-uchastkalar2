...
<body class="bg-gray-50 antialiased">
   ...
   class="nav-item flex items-center justify-between px-3 py-2.5 rounded-lg <?php echo e(request()->routeIs('yer-sotuvlar.fin-xisobot') ? 'active' : ''); ?>">
    ...
    <div class="flex items-center space-x-3">
        ...
        <span class="nav-text text-sm font-medium <?php echo e(request()->routeIs('yer-sotuvlar.fin-xisobot') ? 'text-white' : 'text-gray-700'); ?>">
            Молиявий Хисобот
        </span>
    </div>
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-500">
                        ...
                        <?php if($latestLotDate): ?>
                            <span class="text-emerald-600 font-medium">| Лот: <?php echo e(\Carbon\Carbon::parse($latestLotDate)->format('d.m.Y')); ?></span>
                        <?php endif; ?>
                        <?php if($latestPaymentDate): ?>
                            <span class="text-blue-600 font-medium">| Тўлов: <?php echo e(\Carbon\Carbon::parse($latestPaymentDate)->format('d.m.Y')); ?></span>
                        <?php endif; ?>
                    </p>
                </div>
