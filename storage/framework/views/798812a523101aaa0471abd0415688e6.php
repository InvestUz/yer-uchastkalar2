...
<body class="bg-gradient-to-br from-slate-50 via-blue-50 to-slate-50 min-h-screen antialiased">
                    ...
                    <a href="<?php echo e(route('yer-sotuvlar.svod3')); ?>"
                       class="nav-link px-5 py-2.5 rounded-lg text-sm font-semibold transition-all duration-300 <?php echo e(request()->routeIs('yer-sotuvlar.svod3') ? 'bg-gradient-to-r from-blue-600 to-blue-700 text-white shadow-lg nav-active' : 'text-slate-700 hover:bg-blue-50 hover:text-blue-700'); ?>">
                        <div class="flex items-center space-x-2">
                            ...
                            <span>Бўлиб тўлаш б-ча йиғма маълуот</span>
                        </div>
                    </a>
                ...
                <div class="hidden md:block text-right">
                    ...
                    <div class="flex items-center justify-end space-x-2 text-xs text-slate-600 font-medium">
                        <div class="flex items-center space-x-1.5 bg-blue-50 px-3 py-1 rounded-full">
                            ...
                            <span class="text-blue-700 font-semibold"><?php echo e(now()->format('d.m.Y H:i')); ?></span>
                        </div>
                    </div>
                </div>

                <!-- Mobile Menu Button -->
                <button class="lg:hidden p-2 rounded-lg hover:bg-blue-50 transition-colors" onclick="toggleMobileMenu()">
    ...
    <!-- Premium Footer -->
    <footer class="bg-gradient-to-r from-slate-800 via-slate-700 to-slate-800 border-t-4 border-blue-600 mt-16 no-print">
        <div class="mx-auto px-6 lg:px-12 xl:px-16 py-10">
            <div class="flex flex-col md:flex-row justify-between items-center space-y-6 md:space-y-0">
                ...
                <div class="flex flex-col sm:flex-row items-center space-y-3 sm:space-y-0 sm:space-x-6">
                    <a href="tel:+998712100261" class="flex items-center space-x-2 text-blue-100 hover:text-white transition-all duration-300 group">
                    ...
                    <a href="mailto:info@tashkentinvest.com" class="flex items-center space-x-2 text-blue-100 hover:text-white transition-all duration-300 group">
                        <div class="w-10 h-10 bg-blue-600 rounded-lg flex items-center justify-center group-hover:bg-blue-500 transition-colors">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
