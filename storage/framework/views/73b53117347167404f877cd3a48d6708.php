        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
            <div class="bg-white px-6 py-4">
                <div class="flex flex-col md:flex-row md:justify-between md:items-center">
                    <div>
                        ...
                        <p class="text-gray-600 text-sm mt-1" style="font-weight:bold !important;"><?php echo e($yer->tuman); ?> • <?php echo e($yer->mfy); ?> •
                            <?php echo e($yer->unikal_raqam); ?></p>
                    </div>

                    
                    <form method="GET" action="<?php echo e(route('yer-sotuvlar.show', $yer->lot_raqami)); ?>" class="flex items-center gap-2 mt-3 md:mt-0">
                        <input type="date" name="date_to" value="<?php echo e($dateFilters['date_to']); ?>"
                        ...
                        <?php if(request('date_to')): ?>
                            <a href="<?php echo e(route('yer-sotuvlar.show', $yer->lot_raqami)); ?>" class="px-3 py-1.5 text-sm bg-gray-200 text-gray-700 rounded-md hover:bg-gray-300 transition-colors">
                                Бугун
                            </a>
                        <?php endif; ?>
                    </form>
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-3 p-4 bg-gray-50 border-b border-gray-200">
                ...
                <div class="text-center p-3 bg-white text-gray-600 rounded font-bold">
                    ...
                    <div class="text-lg font-bold"><?php echo e(number_format($totalGrafikByDate, 2)); ?> сўм
                    </div>
                </div>
                ...
                <div class="text-center p-3 bg-white text-gray-600 rounded font-bold">
                    ...
                    <div class="text-lg font-bold">
                        <?php echo e(number_format($totalFaktTolangan, 2)); ?>
                ...
                <div class="text-center p-3 bg-white text-gray-600 rounded font-bold">
                    ...
                    <?php echo e(number_format($qoldiqQiymat, 2)); ?>
                ...
                <?php if($isMuddatli): ?>
                <div class="text-center p-3 bg-white rounded border <?php echo e($muddatiUtganQarz > 0.05 ? 'border-red-200' : ($muddatiUtganQarz < -0.05 ? 'border-green-200' : 'border-gray-200')); ?>">
                    <?php if($muddatiUtganQarz > 0.05): ?>
                        <div class="text-xs text-gray-600">Муддати ўтган қарздорлик</div>
                        <div class="text-lg font-bold text-red-700">
                            <?php echo e(number_format($muddatiUtganQarz, 2)); ?> сўм
                        </div>
                    <?php elseif($muddatiUtganQarz < -0.05): ?>
                        <div class="text-xs text-gray-600">Ортиқча тўланган қиймат</div>
                        <div class="text-lg font-bold text-green-700">
                            <?php echo e(number_format(abs($muddatiUtganQarz), 2)); ?> сўм
                        </div>
                    <?php else: ?>
