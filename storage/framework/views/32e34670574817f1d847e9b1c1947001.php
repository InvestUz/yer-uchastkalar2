                    ...
                    <table class="w-full border-collapse statistics-table">
                        <thead>
                            ...
                            <tr style="background:#eff6ff !important;">
                                ...
                                <!-- Bolib - 10 columns -->
                                <th colspan="4" rowspan="1" class="border border-slate-300 px-2 py-2 text-center font-semibold text-slate-700 text-xs">шундан</th>
                                <th colspan="6" rowspan="1" class="border border-slate-300 px-2 py-2 text-center font-semibold text-slate-700 text-xs"><?php echo e(now()->format('d.m.Y')); ?> йил ҳолатига</th>
                        ...
                        <tbody class="bg-white">
                            ...
                            <tr class="bg-gradient-to-r from-amber-100 via-yellow-100 to-amber-100 border-y-2 border-amber-400">
                                ...
                                <td class="border border-slate-300 px-2 py-2 text-right font-bold text-slate-900"><?php echo e(number_format($jami['grafik_foiz'], 1)); ?>%</td>
                            ...
                            <tr class="hover:bg-blue-50 transition-colors duration-150 <?php echo e($index % 2 == 0 ? 'bg-white' : 'bg-slate-50'); ?>">
                                ...
                                <td class="border border-slate-300 px-2 py-2 text-right text-slate-700 <?php echo e($stat['grafik_foiz'] >= 90 ? 'bg-green-100' : ($stat['grafik_foiz'] >= 70 ? 'bg-yellow-100' : 'bg-red-100')); ?>">
                                    <?php echo e(number_format($stat['grafik_foiz'], 1)); ?>%
                                </td>
