                        ...
                        <tbody class="bg-white">
                            ...
                            <tr class="bg-gradient-to-r from-amber-100 via-yellow-100 to-amber-100 border-y-2 border-amber-400">
                                ...
                                <td class="border border-slate-300 px-2 py-2 text-right font-bold text-slate-900">
                                    <a href="<?php echo e(route('yer-sotuvlar.list', ['include_all' => 'false', 'auksion_sana_from' => $dateFilters['auksion_sana_from'], 'auksion_sana_to' => $dateFilters['auksion_sana_to']])); ?>" class="text-blue-700 hover:text-blue-900 hover:underline"><?php echo e($jami['jami_soni']); ?></a>
                                </td>
                                ...
                                <!-- Col 7: Бир йўла - Сони -->
                                <td class="border border-slate-300 px-2 py-2 text-right font-bold text-slate-900">
                                    <a href="<?php echo e(route('yer-sotuvlar.list', ['tolov_turi' => 'муддатли эмас', 'include_all' => 'false', 'auksion_sana_from' => $dateFilters['auksion_sana_from'], 'auksion_sana_to' => $dateFilters['auksion_sana_to']])); ?>" class="text-blue-700 hover:text-blue-900 hover:underline"><?php echo e($jami['biryola_soni']); ?></a>
                                </td>
                                ...
                                <td class="border border-slate-300 px-2 py-2 text-right font-bold text-slate-900">
                                    <a href="<?php echo e(route('yer-sotuvlar.list', ['tolov_turi' => 'муддатли', 'include_all' => 'false', 'auksion_sana_from' => $dateFilters['auksion_sana_from'], 'auksion_sana_to' => $dateFilters['auksion_sana_to']])); ?>" class="text-blue-700 hover:text-blue-900 hover:underline"><?php echo e($jami['bolib_soni']); ?></a>
                                </td>
                            ...
                            <tr class="hover:bg-blue-50 transition-colors duration-150 <?php echo e($index % 2 == 0 ? 'bg-white' : 'bg-slate-50'); ?>">
                                ...
                                <td class="border border-slate-300 px-2 py-2 text-right text-slate-700">
                                    <?php if($stat['jami_soni'] > 0): ?>
                                        <a href="<?php echo e(route('yer-sotuvlar.list', ['tuman' => $stat['tuman'], 'include_all' => 'false', 'auksion_sana_from' => $dateFilters['auksion_sana_from'], 'auksion_sana_to' => $dateFilters['auksion_sana_to']])); ?>" class="text-blue-600 hover:text-blue-800 hover:underline"><?php echo e($stat['jami_soni']); ?></a>
                                    <?php else: ?>
                                ...
                                <td class="border border-slate-300 px-2 py-2 text-right text-slate-700">
                                    <?php if($stat['biryola_soni'] > 0): ?>
                                        <a href="<?php echo e(route('yer-sotuvlar.list', ['tuman' => $stat['tuman'], 'tolov_turi' => 'муддатли эмас', 'include_all' => 'false', 'auksion_sana_from' => $dateFilters['auksion_sana_from'], 'auksion_sana_to' => $dateFilters['auksion_sana_to']])); ?>" class="text-blue-600 hover:text-blue-800 hover:underline"><?php echo e($stat['biryola_soni']); ?></a>
                                    <?php else: ?>
                                        <span class="text-slate-400">0</span>
                                    <?php endif; ?>
                                </td>
                                ...
                                <td class="border border-slate-300 px-2 py-2 text-right text-slate-700">
                                    <?php if($stat['bolib_soni'] > 0): ?>
                                        <a href="<?php echo e(route('yer-sotuvlar.list', ['tuman' => $stat['tuman'], 'tolov_turi' => 'муддатли', 'include_all' => 'false', 'auksion_sana_from' => $dateFilters['auksion_sana_from'], 'auksion_sana_to' => $dateFilters['auksion_sana_to']])); ?>" class="text-blue-600 hover:text-blue-800 hover:underline"><?php echo e($stat['bolib_soni']); ?></a>
                                    <?php else: ?>
                                        <span class="text-slate-400">0</span>
                                    <?php endif; ?>
                                </td>
