                ...
                <div class="bg-gray-50 px-6 py-5">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3 mb-3">
                        ...
                        <div class="text-center p-3 bg-white rounded-lg border border-gray-200">
                            ...
                            <div class="text-2xl font-bold text-gray-900"><?php echo e(number_format($statistics['total_area'], 2)); ?></div>
                        </div>
                        <div class="text-center p-3 bg-white rounded-lg border border-gray-200">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-3">
                        <div class="text-center p-3 bg-white rounded-lg border border-gray-200">
                            ...
                            <div class="text-lg font-bold" style="color: rgb(29, 78, 216);">
                                ...
                                ?>
                                <?php echo e(number_format($auksion_harajati / 1000000000, 2)); ?>
                        ...
                        <div class="text-center p-3 bg-white rounded-lg border border-gray-200">
                            ...
                            <div class="text-lg font-bold" style="color: rgb(29, 78, 216);">
                                ...
                                ?>
                                <?php echo e(number_format($tushadigan / 1000000000, 2)); ?>
                        ...
                        <div class="text-center p-3 bg-white rounded-lg border border-gray-200">
                            ...
                            <div class="text-lg font-bold" style="color: rgb(29, 78, 216);">
                                <?php echo e(number_format(($statistics['shartnoma_summasi'] ?? 0) / 1000000000, 2)); ?>
                        ...
                        <div class="text-center p-3 bg-white rounded-lg border border-gray-200">
                            ...
                            <div class="text-lg font-bold text-green-600">
                                <?php echo e(number_format(($statistics['fakt_tolangan'] ?? 0) / 1000000000, 2)); ?>
