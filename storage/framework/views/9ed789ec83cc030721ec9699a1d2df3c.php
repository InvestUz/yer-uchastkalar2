                    ...
                    <table class="w-full border-collapse statistics-table">
                        ...
                        <tbody class="bg-white">
                            ...
                            <tr class="bg-gradient-to-r from-amber-100 via-yellow-100 to-amber-100 border-y-2 border-amber-400">
                                ...
                                <td class="border border-slate-300 px-3 py-3 text-right font-bold text-slate-900"><?php echo e(number_format($statistics['jami']['jami']['maydoni'], 2)); ?></td>
                                <td class="border border-slate-300 px-3 py-3 text-right font-bold text-slate-900"><?php echo e(number_format($statistics['jami']['jami']['boshlangich_narx'] / 1000000000, 1)); ?></td>
                                <td class="border border-slate-300 px-3 py-3 text-right font-bold text-slate-900"><?php echo e(number_format($statistics['jami']['jami']['sotilgan_narx'] / 1000000000, 1)); ?></td>
                                <td class="border border-slate-300 px-3 py-3 text-right font-bold text-slate-900"><?php echo e(number_format($statistics['jami']['jami']['chegirma'] / 1000000000, 1)); ?></td>
                                <td class="border border-slate-300 px-3 py-3 text-right font-bold text-slate-900"><?php echo e(number_format($statistics['jami']['jami']['tushadigan_mablagh'] / 1000000000, 1)); ?></td>
                                <!-- Bir yo'la -->
                                <td class="border border-slate-300 px-3 py-3 text-right font-bold text-slate-900">
                                ...
                                <td class="border border-slate-300 px-3 py-3 text-right font-bold text-slate-900"><?php echo e(number_format($statistics['jami']['bir_yola']['maydoni'], 2)); ?></td>
                                <td class="border border-slate-300 px-3 py-3 text-right font-bold text-slate-900"><?php echo e(number_format($statistics['jami']['bir_yola']['boshlangich_narx'] / 1000000000, 1)); ?></td>
                                <td class="border border-slate-300 px-3 py-3 text-right font-bold text-slate-900"><?php echo e(number_format($statistics['jami']['bir_yola']['sotilgan_narx'] / 1000000000, 1)); ?></td>
                                <td class="border border-slate-300 px-3 py-3 text-right font-bold text-slate-900"><?php echo e(number_format($statistics['jami']['bir_yola']['chegirma'] / 1000000000, 1)); ?></td>
                                <td class="border border-slate-300 px-3 py-3 text-right font-bold text-slate-900"><?php echo e(number_format($statistics['jami']['bir_yola']['tushadigan_mablagh'] / 1000000000, 1)); ?></td>
                                <!-- Bo'lib to'lash -->
                                <td class="border border-slate-300 px-3 py-3 text-right font-bold text-slate-900">
                                ...
                                <td class="border border-slate-300 px-3 py-3 text-right font-bold text-slate-900"><?php echo e(number_format($statistics['jami']['bolib']['maydoni'], 2)); ?></td>
                                <td class="border border-slate-300 px-3 py-3 text-right font-bold text-slate-900"><?php echo e(number_format($statistics['jami']['bolib']['boshlangich_narx'] / 1000000000, 1)); ?></td>
                                <td class="border border-slate-300 px-3 py-3 text-right font-bold text-slate-900"><?php echo e(number_format($statistics['jami']['bolib']['sotilgan_narx'] / 1000000000, 1)); ?></td>
                                <td class="border border-slate-300 px-3 py-3 text-right font-bold text-slate-900"><?php echo e(number_format($statistics['jami']['bolib']['chegirma'] / 1000000000, 1)); ?></td>
                                <td class="border border-slate-300 px-3 py-3 text-right font-bold text-slate-900"><?php echo e(number_format($statistics['jami']['bolib']['tushadigan_mablagh'] / 1000000000, 1)); ?></td>
                                <!-- Auksonda turgan -->
                                <td class="border border-slate-300 px-3 py-3 text-right font-bold text-slate-900">
                                ...
                                <td class="border border-slate-300 px-3 py-3 text-right font-bold text-slate-900"><?php echo e(number_format($statistics['jami']['auksonda']['maydoni'], 2)); ?></td>
                                <td class="border border-slate-300 px-3 py-3 text-right font-bold text-slate-900"><?php echo e(number_format($statistics['jami']['auksonda']['boshlangich_narx'] / 1000000000, 1)); ?></td>
                                <td class="border border-slate-300 px-3 py-3 text-right font-bold text-slate-900"><?php echo e(number_format($statistics['jami']['auksonda']['sotilgan_narx'] / 1000000000, 1)); ?></td>
                                <!-- Mulk qabul qilmagan -->
                                <td class="border border-slate-300 px-3 py-3 text-right font-bold text-slate-900">
                                ...
                                <td class="border border-slate-300 px-3 py-3 text-right font-bold text-slate-900"><?php echo e(number_format($statistics['jami']['mulk_qabul']['auksion_mablagh'] / 1000000000, 1)); ?></td>
                            </tr>
                            ...
                            <tr class="hover:bg-blue-50 transition-colors duration-150 <?php echo e($index % 2 == 0 ? 'bg-white' : 'bg-slate-50'); ?>">
                                <td class="sticky-col border border-slate-300 px-3 py-3 text-center align-middle font-medium text-slate-700"><?php echo e($index + 1); ?></td>
                                <td class="sticky-col-2 border border-slate-300 px-3 py-3 align-middle font-semibold text-slate-800"><?php echo e($tuman['tuman']); ?></td>
                                <!-- Jami sotilgan -->
                                ...
                                <td class="border border-slate-300 px-3 py-3 text-right text-slate-700"><?php echo e(number_format($tuman['jami']['maydoni'], 2)); ?></td>
                                <td class="border border-slate-300 px-3 py-3 text-right text-slate-700"><?php echo e(number_format($tuman['jami']['boshlangich_narx'] / 1000000000, 1)); ?></td>
                                <td class="border border-slate-300 px-3 py-3 text-right text-slate-700"><?php echo e(number_format($tuman['jami']['sotilgan_narx'] / 1000000000, 1)); ?></td>
                                <td class="border border-slate-300 px-3 py-3 text-right text-slate-700"><?php echo e(number_format($tuman['jami']['chegirma'] / 1000000000, 1)); ?></td>
                                <td class="border border-slate-300 px-3 py-3 text-right text-slate-700"><?php echo e(number_format($tuman['jami']['tushadigan_mablagh'] / 1000000000, 1)); ?></td>
                                <!-- Bir yo'la -->
                                <td class="border border-slate-300 px-3 py-3 text-right text-slate-700">
                                ...
                                <td class="border border-slate-300 px-3 py-3 text-right text-slate-700"><?php echo e(number_format($tuman['bir_yola']['maydoni'], 2)); ?></td>
                                <td class="border border-slate-300 px-3 py-3 text-right text-slate-700"><?php echo e(number_format($tuman['bir_yola']['boshlangich_narx'] / 1000000000, 1)); ?></td>
                                <td class="border border-slate-300 px-3 py-3 text-right text-slate-700"><?php echo e(number_format($tuman['bir_yola']['sotilgan_narx'] / 1000000000, 1)); ?></td>
                                <td class="border border-slate-300 px-3 py-3 text-right text-slate-700"><?php echo e(number_format($tuman['bir_yola']['chegirma'] / 1000000000, 1)); ?></td>
                                <td class="border border-slate-300 px-3 py-3 text-right text-slate-700"><?php echo e(number_format($tuman['bir_yola']['tushadigan_mablagh'] / 1000000000, 1)); ?></td>
                                <!-- Bo'lib to'lash -->
                                <td class="border border-slate-300 px-3 py-3 text-right text-slate-700">
                                ...
                                <td class="border border-slate-300 px-3 py-3 text-right text-slate-700"><?php echo e(number_format($tuman['bolib']['maydoni'], 2)); ?></td>
                                <td class="border border-slate-300 px-3 py-3 text-right text-slate-700"><?php echo e(number_format($tuman['bolib']['boshlangich_narx'] / 1000000000, 1)); ?></td>
                                <td class="border border-slate-300 px-3 py-3 text-right text-slate-700"><?php echo e(number_format($tuman['bolib']['sotilgan_narx'] / 1000000000, 1)); ?></td>
                                <td class="border border-slate-300 px-3 py-3 text-right text-slate-700"><?php echo e(number_format($tuman['bolib']['chegirma'] / 1000000000, 1)); ?></td>
                                <td class="border border-slate-300 px-3 py-3 text-right text-slate-700"><?php echo e(number_format($tuman['bolib']['tushadigan_mablagh'] / 1000000000, 1)); ?></td>
                                <!-- Auksonda turgan -->
                                <td class="border border-slate-300 px-3 py-3 text-right text-slate-700">
                                ...
                                <td class="border border-slate-300 px-3 py-3 text-right text-slate-700"><?php echo e(number_format($tuman['auksonda']['maydoni'], 2)); ?></td>
                                <td class="border border-slate-300 px-3 py-3 text-right text-slate-700"><?php echo e(number_format($tuman['auksonda']['boshlangich_narx'] / 1000000000, 1)); ?></td>
                                <td class="border border-slate-300 px-3 py-3 text-right text-slate-700"><?php echo e(number_format($tuman['auksonda']['sotilgan_narx'] / 1000000000, 1)); ?></td>
                                <!-- Mulk qabul qilmagan -->
                                <td class="border border-slate-300 px-3 py-3 text-right text-slate-700">
                                ...
                                <td class="border border-slate-300 px-3 py-3 text-right text-slate-700"><?php echo e(number_format($tuman['mulk_qabul']['auksion_mablagh'] / 1000000000, 1)); ?></td>
                            </tr>
