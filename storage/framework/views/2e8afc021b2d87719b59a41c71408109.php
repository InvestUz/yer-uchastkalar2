                    ...
                    <table class="w-full border-collapse statistics-table">
                        <thead>
                            ...
                            <tr style="background:#eff6ff !important;">
                                ...
                                <th rowspan="2" class="border border-slate-300 px-2 py-2 text-center align-middle font-semibold text-slate-700 text-xs" style="width: 70px; min-width: 70px; max-width: 70px;">%</th>
                            </tr>
