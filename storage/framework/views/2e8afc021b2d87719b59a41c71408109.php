...
<div class="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 py-6 px-4">
                    ...
                    <table class="w-full border-collapse statistics-table">
                        <thead>
                            ...
                            <tr style="background:#eff6ff !important;">
                                <th rowspan="4" class="sticky-col border border-slate-300 px-2 py-3 text-center align-middle font-bold text-slate-800" style="width: 50px; min-width: 50px; max-width: 50px;">
                                    Т/р
                                </th>
                                <th rowspan="4" class="sticky-col-2 border border-slate-300 px-3 py-3 text-center align-middle font-bold text-slate-800" style="width: 180px; min-width: 180px; max-width: 180px;">
                                    Ҳудудлар
                                </th>
                            ...
                            <tr style="background:#eff6ff !important;">
                                ...
                                <th rowspan="3" class="border border-slate-300 px-2 py-2 text-center align-middle font-semibold text-slate-700 text-xs" style="width: 70px; min-width: 70px; max-width: 70px;">
                                    сони
                                </th>
                                <th rowspan="3" class="border border-slate-300 px-2 py-2 text-center align-middle font-semibold text-slate-700 text-xs" style="width: 85px; min-width: 85px; max-width: 85px;">
                                    майдони<br>(га)
                                </th>
                                <th rowspan="3" class="border border-slate-300 px-2 py-2 text-center align-middle font-semibold text-slate-700 text-xs" style="width: 95px; min-width: 95px; max-width: 95px;">
                                    бошланғич нархи<br>(млрд)
                                </th>
                                <th rowspan="3" class="border border-slate-300 px-2 py-2 text-center align-middle font-semibold text-slate-700 text-xs" style="width: 95px; min-width: 95px; max-width: 95px;">
                                    сотилган нархи<br>(млрд)
                                </th>
                                <th colspan="1" class="border border-slate-300 px-2 py-2 text-center font-semibold text-slate-700 text-xs">
                                    шундан
                                </th>

                                <!-- Shundan holatiga - 11 columns -->
                                <th colspan="5" class="border border-slate-300 px-2 py-2 text-center font-semibold text-slate-700 text-xs">
                                    тўлиқ тўланганлар
                                </th>
                                <th colspan="6" class="border border-slate-300 px-2 py-2 text-center font-semibold text-slate-700 text-xs">
                                    назоратдагилар
                                </th>
                                ...
                                <th colspan="3" class="border border-slate-300 px-2 py-2 text-center font-semibold text-slate-700 text-xs">
                                    шундан
                                </th>
                            </tr>
                            ...
                            <tr style="background:#eff6ff !important;">
                                ...
                                <th rowspan="2" class="border border-slate-300 px-2 py-2 text-center align-middle font-semibold text-slate-700 text-xs" style="width: 100px; min-width: 100px; max-width: 100px;">
                                    Тушадиган қиймат<br>(млрд)
                                </th>

                                <!-- Toliq tolanganlar - 5 columns -->
                                <th rowspan="2" class="border border-slate-300 px-2 py-2 text-center align-middle font-semibold text-slate-700 text-xs" style="width: 70px; min-width: 70px; max-width: 70px;">сони</th>
                                <th rowspan="2" class="border border-slate-300 px-2 py-2 text-center align-middle font-semibold text-slate-700 text-xs" style="width: 85px; min-width: 85px; max-width: 85px;">майдони<br>(га)</th>
                                <th rowspan="2" class="border border-slate-300 px-2 py-2 text-center align-middle font-semibold text-slate-700 text-xs" style="width: 95px; min-width: 95px; max-width: 95px;">бошланғич<br>(млрд)</th>
                                <th rowspan="2" class="border border-slate-300 px-2 py-2 text-center align-middle font-semibold text-slate-700 text-xs" style="width: 95px; min-width: 95px; max-width: 95px;">сотилган<br>(млрд)</th>
                                ...
                                <th rowspan="2" class="border border-slate-300 px-2 py-2 text-center align-middle font-semibold text-slate-700 text-xs" style="width: 100px; min-width: 100px; max-width: 100px;">график<br>(млрд)</th>
                                <th rowspan="2" class="border border-slate-300 px-2 py-2 text-center align-middle font-semibold text-slate-700 text-xs" style="width: 100px; min-width: 100px; max-width: 100px;">амалда<br>(млрд)</th>
                                <th rowspan="2" class="border border-slate-300 px-2 py-2 text-center align-middle font-semibold text-slate-700 text-xs" style="width: 110px; min-width: 110px; max-width: 110px;">муддати ўтган қарздорлик<br>(млрд)</th>
                            </tr>

                            <!-- Row 4: Bottom level details -->
                            <tr style="background:#eff6ff !important;">
                                <!-- Under "shundan" of Toliq tolanganlar -->
                                <th class="border border-slate-300 px-2 py-2 text-center font-semibold text-slate-700 text-xs" style="width: 100px; min-width: 100px; max-width: 100px;">
                                    тушган<br>(млрд)
                                </th>
    ...
    <a href="<?php echo e(route('yer-sotuvlar.list', ['tolov_turi' => 'муддатли', 'grafik_ortda' => 'true'])); ?>" class="text-blue-700 hover:text-blue-900 hover:underline transition-all">
        <?php echo e($statistics['jami']['grafik_ortda']['soni']); ?>
                                ...
                                <td class="border border-slate-300 px-2 py-2 text-right font-bold text-slate-900">
                                    <?php echo e(number_format(($statistics['jami']['grafik_ortda']['muddati_utgan_qarz'] ?? 0) / 1000000000, 1)); ?>
                            ...
                            <tr class="hover:bg-blue-50 transition-colors duration-150 <?php echo e($index % 2 == 0 ? 'bg-white' : 'bg-slate-50'); ?>">
                                ...
                                <td class="border border-slate-300 px-2 py-2 text-right text-slate-700">
                                    <?php echo e(number_format(($tuman['grafik_ortda']['muddati_utgan_qarz'] ?? 0) / 1000000000, 1)); ?>
