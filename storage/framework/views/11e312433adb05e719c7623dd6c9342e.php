        ...
        <div class="bg-white rounded-xl shadow-lg p-6 mb-8">
            <div class="flex items-center justify-between mb-6">
                ...
                <span class="text-sm text-slate-500 bg-slate-100 px-4 py-2 rounded-lg font-semibold">
                    <?php if(request('period') === 'month'): ?>
                        <?php echo e(\Carbon\Carbon::create(request('year', now()->year), request('month', now()->month), 1)->locale('uz')->translatedFormat('F Y')); ?> ойи ҳолатига
                    <?php elseif(request('period') === 'quarter'): ?>
                        <?php echo e(request('quarter', ceil(now()->month / 3))); ?>-чорак ҳолатига <?php echo e(request('year', now()->year)); ?> й
                    <?php elseif(request('period') === 'year'): ?>
                        <?php echo e(request('year', now()->year)); ?> йил ҳолатига
                    <?php else: ?>
                        Барча давр
                    <?php endif; ?>
                </span>
            ...
            <div class="flex gap-0 border border-gray-300 rounded-lg overflow-hidden mb-6">
                <button
                    ...
                    class="flex-1 px-6 py-3 text-sm font-semibold period-filter-btn transition-all border-r border-gray-300 <?php echo e(request('period') === 'month' ? 'bg-blue-600 text-white' : 'bg-white text-gray-700 hover:bg-gray-50'); ?>"
                    id="btn-month">
                    Ой бўйича
                </button>
                <button
                    onclick="changePeriod('quarter')"
                    class="flex-1 px-6 py-3 text-sm font-semibold period-filter-btn transition-all border-r border-gray-300 <?php echo e(request('period') === 'quarter' ? 'bg-blue-600 text-white' : 'bg-white text-gray-700 hover:bg-gray-50'); ?>"
                    id="btn-quarter">
                    Чорак бўйича
                </button>
                <button
                    onclick="changePeriod('year')"
                    class="flex-1 px-6 py-3 text-sm font-semibold period-filter-btn transition-all border-r border-gray-300 <?php echo e(request('period') === 'year' ? 'bg-blue-600 text-white' : 'bg-white text-gray-700 hover:bg-gray-50'); ?>"
                    id="btn-year">
                    Йил бўйича
                </button>
                <button
                    onclick="changePeriod('all')"
                    class="flex-1 px-6 py-3 text-sm font-semibold period-filter-btn transition-all <?php echo e(!request('period') || request('period') === 'all' ? 'bg-blue-600 text-white' : 'bg-white text-gray-700 hover:bg-gray-50'); ?>"
                    id="btn-all">
                    Барча давр
                </button>
            </div>
            ...
            <!-- Detailed Filters -->
            <form method="GET" action="<?php echo e(route('yer-sotuvlar.monitoring')); ?>" id="filterForm">
                <input type="hidden" name="period" id="periodInput" value="<?php echo e(request('period', 'all')); ?>">

                <div class="grid grid-cols-1 md:grid-cols-3 gap-4" id="detailFilters" style="display: <?php echo e(request('period') && request('period') !== 'all' ? 'grid' : 'none'); ?>;">

                    <!-- Year Filter -->
                    <?php if(request('period') === 'month' || request('period') === 'quarter' || request('period') === 'year'): ?>
                    <div>
                    ...
                    <div>
                        ...
                        <select name="month" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all" onchange="this.form.submit()">
                            ...
                            <?php $__currentLoopData = $months; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $monthNum => $monthName): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($monthNum); ?>" <?php echo e(request('month', now()->month) == $monthNum ? 'selected' : ''); ?>>
                    ...
                    <div>
                        ...
                        <select name="quarter" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all" onchange="this.form.submit()">
                            <?php for($q = 1; $q <= 4; $q++): ?>
                                <option value="<?php echo e($q); ?>" <?php echo e(request('quarter', ceil(now()->month / 3)) == $q ? 'selected' : ''); ?>>
                                    <?php echo e($q); ?>-чорак
                                </option>
                            <?php endfor; ?>
                        </select>
        ...
        <div id="content-muddatli" class="tab-content">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 mb-8">
                ...
                <div class="bg-white rounded-xl shadow-lg p-6 border-l-4 border-red-500 hover:shadow-xl transition-shadow">
                    ...
                    <p class="text-3xl font-bold text-red-700 mb-1"><?php echo e(number_format($summaryMuddatli['total_lots'])); ?> та</p>
                ...
                <div class="bg-white rounded-xl shadow-lg p-6 border-l-4 border-blue-500 hover:shadow-xl transition-shadow">
                    ...
                    <p class="text-3xl font-bold text-blue-700 mb-1"><?php echo e(number_format($summaryMuddatli['expected_amount'] / 1000000000, 2)); ?> млрд</p>
                ...
                <div class="bg-white rounded-xl shadow-lg p-6 border-l-4 border-purple-500 hover:shadow-xl transition-shadow">
                    ...
                    <p class="text-3xl font-bold text-purple-700 mb-1"><?php echo e(number_format($grafikTushadiganMuddatli / 1000000000, 2)); ?> млрд</p>
                ...
                <div class="bg-white rounded-xl shadow-lg p-6 border-l-4 border-green-500 hover:shadow-xl transition-shadow">
                    ...
                    <p class="text-3xl font-bold text-green-700 mb-2"><?php echo e(number_format($summaryMuddatli['received_amount'] / 1000000000, 2)); ?> млрд</p>
                    <?php
                    ...
                    <div class="flex items-center">
                        <div class="flex-1 bg-gray-200 rounded-full h-2.5 mr-3">
                            <div class="bg-green-600 h-2.5 rounded-full transition-all duration-500" style="width: <?php echo e(min(100, $tolovFoiziMuddatli)); ?>%"></div>
                        </div>
                        <span class="text-sm font-bold text-green-600"><?php echo e(number_format($tolovFoiziMuddatli, 1)); ?>%</span>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-lg p-6 border-l-4 border-orange-500 hover:shadow-xl transition-shadow">
                    ...
                    <p class="text-3xl font-bold text-orange-700 mb-1"><?php echo e(number_format($muddatiOtganMuddatli / 1000000000, 2)); ?> млрд</p>
                    ...
                    <table class="w-full">
                        ...
                        <tbody class="divide-y divide-slate-200">
                            ...
                            <tr class="hover:bg-blue-50 transition-colors">
                                ...
                                <td class="px-4 py-3 text-right text-sm font-semibold text-blue-600"><?php echo e(number_format($stat['grafik'] / 1000000000, 2)); ?></td>
                                <td class="px-4 py-3 text-right text-sm font-semibold text-green-600"><?php echo e(number_format($stat['fakt'] / 1000000000, 2)); ?></td>
                                ...
                                <td class="px-4 py-3">
                                    <div class="flex items-center justify-center gap-2">
                                        ...
                                        <span class="text-sm font-bold text-blue-600"><?php echo e(number_format($stat['percentage'], 1)); ?>%</span>
                                    </div>
                                </td>
                            </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <tfoot class="bg-gradient-to-r from-yellow-50 to-yellow-100 border-t-2 border-yellow-300 font-bold">
                            <tr>
                                ...
                                <td class="px-4 py-3 text-right text-sm text-blue-700"><?php echo e(number_format(collect($tumanStatsMuddatli)->sum('grafik') / 1000000000, 2)); ?></td>
                                <td class="px-4 py-3 text-right text-sm text-green-700"><?php echo e(number_format(collect($tumanStatsMuddatli)->sum('fakt') / 1000000000, 2)); ?></td>
        ...
        <div id="content-muddatli-emas" class="tab-content" style="display: none;">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 mb-8">
                ...
                <div class="bg-white rounded-xl shadow-lg p-6 border-l-4 border-red-500 hover:shadow-xl transition-shadow">
                    ...
                    <p class="text-3xl font-bold text-red-700 mb-1"><?php echo e(number_format($summaryMuddatliEmas['total_lots'])); ?> та</p>
                ...
                <div class="bg-white rounded-xl shadow-lg p-6 border-l-4 border-blue-500 hover:shadow-xl transition-shadow">
                    ...
                    <p class="text-3xl font-bold text-blue-700 mb-1"><?php echo e(number_format($summaryMuddatliEmas['expected_amount'] / 1000000000, 2)); ?> млрд</p>
                    <p class="text-xs text-slate-500">Жами шартнома суммаси</p>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-lg p-6 border-l-4 border-purple-500 hover:shadow-xl transition-shadow">
                    ...
                    <p class="text-3xl font-bold text-purple-700 mb-1"><?php echo e(number_format($summaryMuddatliEmas['expected_amount'] / 1000000000, 2)); ?> млрд</p>
                ...
                <div class="bg-white rounded-xl shadow-lg p-6 border-l-4 border-green-500 hover:shadow-xl transition-shadow">
                    ...
                    <p class="text-3xl font-bold text-green-700 mb-2"><?php echo e(number_format($summaryMuddatliEmas['received_amount'] / 1000000000, 2)); ?> млрд</p>
                    <div class="flex items-center">
                        <div class="flex-1 bg-gray-200 rounded-full h-2.5 mr-3">
                            <div class="bg-green-600 h-2.5 rounded-full transition-all duration-500" style="width: <?php echo e(min(100, $summaryMuddatliEmas['payment_percentage'])); ?>%"></div>
                        </div>
                        <span class="text-sm font-bold text-green-600"><?php echo e(number_format($summaryMuddatliEmas['payment_percentage'], 1)); ?>%</span>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-lg p-6 border-l-4 border-orange-500 hover:shadow-xl transition-shadow">
                    ...
                    <p class="text-3xl font-bold text-orange-700 mb-1"><?php echo e(number_format($muddatiOtganMuddatliEmas / 1000000000, 2)); ?> млрд</p>
                    ...
                    <table class="w-full">
                        ...
                        <tbody class="divide-y divide-slate-200">
                            ...
                            <tr class="hover:bg-green-50 transition-colors">
                                ...
                                <td class="px-4 py-3 text-right text-sm font-semibold text-blue-600"><?php echo e(number_format($stat['expected'] / 1000000000, 2)); ?></td>
                                <td class="px-4 py-3 text-right text-sm font-semibold text-green-600"><?php echo e(number_format($stat['received'] / 1000000000, 2)); ?></td>
                                <td class="px-4 py-3 text-right text-sm font-semibold <?php echo e($stat['difference'] > 0 ? 'text-red-600' : 'text-green-600'); ?>">
                                    <?php echo e(number_format($stat['difference'] / 1000000000, 2)); ?>
                                ...
                                <td class="px-4 py-3">
                                    <div class="flex items-center justify-center gap-2">
                                        ...
                                        <span class="text-sm font-bold text-green-600"><?php echo e(number_format($stat['percentage'], 1)); ?>%</span>
                                    </div>
                                </td>
                            </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <tfoot class="bg-gradient-to-r from-yellow-50 to-yellow-100 border-t-2 border-yellow-300 font-bold">
                            <tr>
                                ...
                                <td class="px-4 py-3 text-right text-sm text-blue-700"><?php echo e(number_format(collect($tumanStatsMuddatliEmas)->sum('expected') / 1000000000, 2)); ?></td>
                                <td class="px-4 py-3 text-right text-sm text-green-700"><?php echo e(number_format(collect($tumanStatsMuddatliEmas)->sum('received') / 1000000000, 2)); ?></td>
