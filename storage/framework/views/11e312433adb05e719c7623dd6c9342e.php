...
<?php $__env->startSection('content'); ?>
    <div class="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-slate-50 py-8">
            ...
            <div class="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl shadow-lg p-6 mb-8">
                ...
                <div id="content-muddatli" class="tab-content">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                        ...
                        <div class="block bg-white rounded-xl shadow-lg p-6 border-l-4 lg:col-start-3"
                            style="border-color: rgb(29 78 216);">
                            <div class="flex items-center justify-between mb-3">
        ...
        function showGrafikDetail() {
            ...
            if (tuman) {
                url += `&tuman=${encodeURIComponent(tuman)}`;
            }
            ...
            fetch(url)
                ...
                .then(data => {
                    ...
                    let html = `
                        <div class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50" onclick="this.remove()">
                            <div class="bg-white rounded-lg shadow-xl max-w-4xl w-full mx-4 max-h-[90vh] overflow-auto" onclick="event.stopPropagation()">
                                <div class="sticky top-0 bg-white border-b px-6 py-4 flex justify-between items-center">
                                    <h2 class="text-2xl font-bold text-blue-700">График бўйича тушган - Батафсил</h2>
                                ...
                                <div class="p-6">
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                                        <div class="bg-blue-50 p-4 rounded-lg">
                                            <div class="text-sm text-gray-600">Жами сумма</div>
                                            <div class="text-2xl font-bold text-blue-700">${(data.total / 1000000000).toFixed(2)} млрд сўм</div>
                                        </div>
                                        <div class="bg-green-50 p-4 rounded-lg">
                                            <div class="text-sm text-gray-600">Жами лотлар сони</div>
                                            <div class="text-2xl font-bold text-green-700">${data.payments.length} та</div>
                                        </div>
                                    </div>
                                        ...
                                        <table class="min-w-full divide-y divide-gray-200">
                                            <thead class="bg-gray-50">
                                                <tr>
                                                    ...
                                                    <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase">Лот рақами</th>
                                                    <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase">Тўловчи номи</th>
                    ...
                    data.payments.forEach((p, i) => {
                        html += `
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-4 py-3 text-sm font-medium text-blue-600">${p.lot_raqami}</td>
                                <td class="px-4 py-3 text-sm text-gray-900">${p.tolash_nom || '-'}</td>
                                <td class="px-4 py-3 text-sm text-right font-semibold">${(p.tolov_summa / 1000000).toFixed(2)} млн</td>
                            </tr>
                        `;
                    });
                ...
                .catch(err => {
                    ...
                    alert('Маълумот юклашда хатолик: ' + err.message);
                });
        }
        </script>
