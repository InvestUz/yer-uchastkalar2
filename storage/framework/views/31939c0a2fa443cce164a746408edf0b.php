<?php $__env->startSection('title', 'Янги Ер Участка Қўшиш'); ?>
...
<div class="max-w-7xl mx-auto">
    ...
    <!-- Form -->
    <form action="<?php echo e(route('yer-sotuvlar.store')); ?>" method="POST" class="space-y-6" id="createForm">
        <?php echo csrf_field(); ?>
        ...
        <div class="bg-white rounded-xl shadow-lg p-6 border-l-4 border-blue-500">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="lot_raqami" value="<?php echo e(old('lot_raqami')); ?>"
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <select name="tuman" id="tuman"
                        ...
                        <?php $__currentLoopData = $tumanlar; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tuman): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($tuman); ?>" <?php echo e(old('tuman') == $tuman ? 'selected' : ''); ?>><?php echo e($tuman); ?></option>
                ...
                <div>
                    ...
                    <select name="mfy" id="mfy"
                            class="w-full px-4 py-2.5 border-2 border-slate-300 rounded-lg focus:ring-4 focus:ring-blue-200 focus:border-blue-500 transition-all">
                        <option value="">Танланг</option>
                        <?php $__currentLoopData = $mfylar; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mfy): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($mfy); ?>" <?php echo e(old('mfy') == $mfy ? 'selected' : ''); ?>><?php echo e($mfy); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <option value="__other__">Бошқа (ёзиш)</option>
                    </select>
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" name="manzil" value="<?php echo e(old('manzil')); ?>"
                           class="w-full px-4 py-2.5 border-2 border-slate-300 rounded-lg focus:ring-4 focus:ring-blue-200 focus:border-blue-500 transition-all">
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="unikal_raqam" value="<?php echo e(old('unikal_raqam')); ?>"
                           class="w-full px-4 py-2.5 border-2 border-slate-300 rounded-lg focus:ring-4 focus:ring-blue-200 focus:border-blue-500 transition-all">
                </div>
                ...
                <div>
                    ...
                    <select name="zona" id="zona"
                            class="w-full px-4 py-2.5 border-2 border-slate-300 rounded-lg focus:ring-4 focus:ring-blue-200 focus:border-blue-500 transition-all">
                        <option value="">Танланг</option>
                        <?php $__currentLoopData = $zonalar; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $zona): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($zona); ?>" <?php echo e(old('zona') == $zona ? 'selected' : ''); ?>><?php echo e($zona); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <option value="__other__">Бошқа (ёзиш)</option>
                    </select>
                ...
                <div>
                    ...
                    <select name="bosh_reja_zona" id="bosh_reja_zona"
                            class="w-full px-4 py-2.5 border-2 border-slate-300 rounded-lg focus:ring-4 focus:ring-blue-200 focus:border-blue-500 transition-all">
                        <option value="">Танланг</option>
                        <?php $__currentLoopData = $boshRejaZonalari; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $brz): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($brz); ?>" <?php echo e(old('bosh_reja_zona') == $brz ? 'selected' : ''); ?>><?php echo e($brz); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <option value="__other__">Бошқа (ёзиш)</option>
                    </select>
                ...
                <div>
                    ...
                    <select name="yangi_ozbekiston" id="yangi_ozbekiston"
                            class="w-full px-4 py-2.5 border-2 border-slate-300 rounded-lg focus:ring-4 focus:ring-blue-200 focus:border-blue-500 transition-all">
                        <option value="">Танланг</option>
                        <?php $__currentLoopData = $yangiOzbekiston; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $yo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($yo); ?>" <?php echo e(old('yangi_ozbekiston') == $yo ? 'selected' : ''); ?>><?php echo e($yo); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <option value="__other__">Бошқа (ёзиш)</option>
                    </select>
                ...
                <div>
                    ...
                    <input type="number" step="0.0001" name="maydoni" value="<?php echo e(old('maydoni')); ?>"
                           class="w-full px-4 py-2.5 border-2 border-slate-300 rounded-lg focus:ring-4 focus:ring-blue-200 focus:border-blue-500 transition-all">
                </div>
                ...
                <div>
                    ...
                    <input type="number" name="yil" value="<?php echo e(old('yil', date('Y'))); ?>"
                           class="w-full px-4 py-2.5 border-2 border-slate-300 rounded-lg focus:ring-4 focus:ring-blue-200 focus:border-blue-500 transition-all">
                </div>
                ...
                <div class="md:col-span-2 lg:col-span-3">
                    ...
                    <textarea name="lokatsiya" rows="2"
                              class="w-full px-4 py-2.5 border-2 border-slate-300 rounded-lg focus:ring-4 focus:ring-blue-200 focus:border-blue-500 transition-all"><?php echo e(old('lokatsiya')); ?></textarea>
                </div>
            </div>
        </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <select name="qurilish_turi_1" id="qurilish_turi_1"
                            class="w-full px-4 py-2.5 border-2 border-slate-300 rounded-lg focus:ring-4 focus:ring-blue-200 focus:border-blue-500 transition-all">
                        <option value="">Танланг</option>
                        <?php $__currentLoopData = $qurilishTurlari1; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $qt1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($qt1); ?>" <?php echo e(old('qurilish_turi_1') == $qt1 ? 'selected' : ''); ?>><?php echo e($qt1); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <option value="__other__">Бошқа (ёзиш)</option>
                    </select>
                ...
                <div>
                    ...
                    <select name="qurilish_turi_2" id="qurilish_turi_2"
                            class="w-full px-4 py-2.5 border-2 border-slate-300 rounded-lg focus:ring-4 focus:ring-blue-200 focus:border-blue-500 transition-all">
                        <option value="">Танланг</option>
                        <?php $__currentLoopData = $qurilishTurlari2; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $qt2): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($qt2); ?>" <?php echo e(old('qurilish_turi_2') == $qt2 ? 'selected' : ''); ?>><?php echo e($qt2); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <option value="__other__">Бошқа (ёзиш)</option>
                    </select>
                ...
                <div>
                    ...
                    <input type="number" step="0.01" name="qurilish_maydoni" value="<?php echo e(old('qurilish_maydoni')); ?>"
                           class="w-full px-4 py-2.5 border-2 border-slate-300 rounded-lg focus:ring-4 focus:ring-blue-200 focus:border-blue-500 transition-all">
                </div>
                ...
                <div>
                    ...
                    <input type="number" step="0.01" name="investitsiya" value="<?php echo e(old('investitsiya')); ?>"
                           class="w-full px-4 py-2.5 border-2 border-slate-300 rounded-lg focus:ring-4 focus:ring-blue-200 focus:border-blue-500 transition-all">
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-lg p-6 border-l-4 border-purple-500">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div>
                    ...
                    <input type="number" step="0.01" name="boshlangich_narx" value="<?php echo e(old('boshlangich_narx')); ?>"
                           class="w-full px-4 py-2.5 border-2 border-slate-300 rounded-lg focus:ring-4 focus:ring-blue-200 focus:border-blue-500 transition-all">
                </div>
                ...
                <div>
                    ...
                    <input type="date" name="auksion_sana" value="<?php echo e(old('auksion_sana')); ?>"
                           class="w-full px-4 py-2.5 border-2 border-slate-300 rounded-lg focus:ring-4 focus:ring-blue-200 focus:border-blue-500 transition-all">
                </div>
                ...
                <div>
                    ...
                    <input type="number" step="0.01" name="sotilgan_narx" value="<?php echo e(old('sotilgan_narx')); ?>"
                           class="w-full px-4 py-2.5 border-2 border-slate-300 rounded-lg focus:ring-4 focus:ring-blue-200 focus:border-blue-500 transition-all">
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="auksion_golibi" value="<?php echo e(old('auksion_golibi')); ?>"
                           class="w-full px-4 py-2.5 border-2 border-slate-300 rounded-lg focus:ring-4 focus:ring-blue-200 focus:border-blue-500 transition-all">
                </div>
                ...
                <div>
                    ...
                    <select name="golib_turi"
                            class="w-full px-4 py-2.5 border-2 border-slate-300 rounded-lg focus:ring-4 focus:ring-blue-200 focus:border-blue-500 transition-all">
                        <option value="">Танланг</option>
                        <option value="юр лицо" <?php echo e(old('golib_turi') == 'юр лицо' ? 'selected' : ''); ?>>юр лицо</option>
                        <option value="физ лицо" <?php echo e(old('golib_turi') == 'физ лицо' ? 'selected' : ''); ?>>физ лицо</option>
                    </select>
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="golib_nomi" value="<?php echo e(old('golib_nomi')); ?>"
                           class="w-full px-4 py-2.5 border-2 border-slate-300 rounded-lg focus:ring-4 focus:ring-blue-200 focus:border-blue-500 transition-all">
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="telefon" value="<?php echo e(old('telefon')); ?>"
                           class="w-full px-4 py-2.5 border-2 border-slate-300 rounded-lg focus:ring-4 focus:ring-blue-200 focus:border-blue-500 transition-all"
                ...
                <div>
                    ...
                    <select name="tolov_turi" id="tolov_turi"
                            class="w-full px-4 py-2.5 border-2 border-slate-300 rounded-lg focus:ring-4 focus:ring-blue-200 focus:border-blue-500 transition-all">
                        <option value="">Танланг</option>
                        <option value="муддатли" <?php echo e(old('tolov_turi') == 'муддатли' ? 'selected' : ''); ?>>муддатли</option>
                        <option value="муддатли эмас" <?php echo e(old('tolov_turi') == 'муддатли эмас' ? 'selected' : ''); ?>>муддатли эмас</option>
                    </select>
                </div>
                ...
                <div>
                    ...
                    <select name="asos" id="asos"
                            class="w-full px-4 py-2.5 border-2 border-slate-300 rounded-lg focus:ring-4 focus:ring-blue-200 focus:border-blue-500 transition-all">
                        <option value="">Танланг</option>
                        <?php $__currentLoopData = $asoslar; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $asos): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($asos); ?>" <?php echo e(old('asos') == $asos ? 'selected' : ''); ?>><?php echo e($asos); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <option value="__other__">Бошқа (ёзиш)</option>
                    </select>
                ...
                <div>
                    ...
                    <select name="auksion_turi"
                            class="w-full px-4 py-2.5 border-2 border-slate-300 rounded-lg focus:ring-4 focus:ring-blue-200 focus:border-blue-500 transition-all">
                        <option value="">Танланг</option>
                        <option value="Очиқ" <?php echo e(old('auksion_turi') == 'Очиқ' ? 'selected' : ''); ?>>Очиқ</option>
                        <option value="Ёпиқ" <?php echo e(old('auksion_turi') == 'Ёпиқ' ? 'selected' : ''); ?>>Ёпиқ</option>
                    </select>
                </div>
                ...
                <div class="md:col-span-2">
                    ...
                    <select name="holat" id="holat"
                            class="w-full px-4 py-2.5 border-2 border-slate-300 rounded-lg focus:ring-4 focus:ring-blue-200 focus:border-blue-500 transition-all">
                        <option value="">Танланг</option>
                        <?php $__currentLoopData = $holatlar; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $holat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($holat); ?>" <?php echo e(old('holat') == $holat ? 'selected' : ''); ?>><?php echo e($holat); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <option value="__other__">Бошқа (ёзиш)</option>
                    </select>
        ...
        <div class="bg-white rounded-xl shadow-lg p-6 border-l-4 border-orange-500">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="shartnoma_holati" value="<?php echo e(old('shartnoma_holati')); ?>"
                           class="w-full px-4 py-2.5 border-2 border-slate-300 rounded-lg focus:ring-4 focus:ring-blue-200 focus:border-blue-500 transition-all">
                </div>
                ...
                <div>
                    ...
                    <input type="date" name="shartnoma_sana" value="<?php echo e(old('shartnoma_sana')); ?>"
                           class="w-full px-4 py-2.5 border-2 border-slate-300 rounded-lg focus:ring-4 focus:ring-blue-200 focus:border-blue-500 transition-all">
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="shartnoma_raqam" value="<?php echo e(old('shartnoma_raqam')); ?>"
                           class="w-full px-4 py-2.5 border-2 border-slate-300 rounded-lg focus:ring-4 focus:ring-blue-200 focus:border-blue-500 transition-all">
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-lg p-6 border-l-4 border-red-500">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div>
                    ...
                    <input type="number" step="0.01" name="golib_tolagan" value="<?php echo e(old('golib_tolagan')); ?>"
                           class="w-full px-4 py-2.5 border-2 border-slate-300 rounded-lg focus:ring-4 focus:ring-blue-200 focus:border-blue-500 transition-all">
                </div>
                ...
                <div>
                    ...
                    <input type="number" step="0.01" name="buyurtmachiga_otkazilgan" value="<?php echo e(old('buyurtmachiga_otkazilgan')); ?>"
                           class="w-full px-4 py-2.5 border-2 border-slate-300 rounded-lg focus:ring-4 focus:ring-blue-200 focus:border-blue-500 transition-all">
                </div>
                ...
                <div>
                    ...
                    <input type="number" step="0.01" name="chegirma" value="<?php echo e(old('chegirma')); ?>"
                           class="w-full px-4 py-2.5 border-2 border-slate-300 rounded-lg focus:ring-4 focus:ring-blue-200 focus:border-blue-500 transition-all">
                </div>
                ...
                <div>
                    ...
                    <input type="number" step="0.01" name="auksion_harajati" value="<?php echo e(old('auksion_harajati')); ?>"
                           class="w-full px-4 py-2.5 border-2 border-slate-300 rounded-lg focus:ring-4 focus:ring-blue-200 focus:border-blue-500 transition-all">
                </div>
                ...
                <div>
                    ...
                    <input type="number" step="0.01" name="tushadigan_mablagh" value="<?php echo e(old('tushadigan_mablagh')); ?>"
                           class="w-full px-4 py-2.5 border-2 border-slate-300 rounded-lg focus:ring-4 focus:ring-blue-200 focus:border-blue-500 transition-all">
                </div>
                ...
                <div>
                    ...
                    <input type="number" step="0.01" name="davaktiv_jamgarmasi" value="<?php echo e(old('davaktiv_jamgarmasi')); ?>"
                           class="w-full px-4 py-2.5 border-2 border-slate-300 rounded-lg focus:ring-4 focus:ring-blue-200 focus:border-blue-500 transition-all">
                </div>
                ...
                <div>
                    ...
                    <input type="number" step="0.01" name="shartnoma_tushgan" value="<?php echo e(old('shartnoma_tushgan')); ?>"
                           class="w-full px-4 py-2.5 border-2 border-slate-300 rounded-lg focus:ring-4 focus:ring-blue-200 focus:border-blue-500 transition-all">
                </div>
                ...
                <div>
                    ...
                    <input type="number" step="0.01" name="davaktivda_turgan" value="<?php echo e(old('davaktivda_turgan')); ?>"
                           class="w-full px-4 py-2.5 border-2 border-slate-300 rounded-lg focus:ring-4 focus:ring-blue-200 focus:border-blue-500 transition-all">
                </div>
                ...
                <div>
                    ...
                    <input type="number" step="0.01" name="yer_auksion_harajat" value="<?php echo e(old('yer_auksion_harajat')); ?>"
                           class="w-full px-4 py-2.5 border-2 border-slate-300 rounded-lg focus:ring-4 focus:ring-blue-200 focus:border-blue-500 transition-all">
                </div>
                ...
                <div>
                    ...
                    <input type="number" step="0.01" name="shartnoma_summasi" value="<?php echo e(old('shartnoma_summasi')); ?>"
                           class="w-full px-4 py-2.5 border-2 border-slate-300 rounded-lg focus:ring-4 focus:ring-blue-200 focus:border-blue-500 transition-all">
                </div>
                ...
                <div>
                    ...
                    <input type="number" step="0.01" name="farqi" value="<?php echo e(old('farqi')); ?>"
                           class="w-full px-4 py-2.5 border-2 border-slate-300 rounded-lg focus:ring-4 focus:ring-blue-200 focus:border-blue-500 transition-all">
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\inves\OneDrive\Ishchi stol\yer-uchastkalar\resources\views/yer-sotuvlar/create.blade.php ENDPATH**/ ?>