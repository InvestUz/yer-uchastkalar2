        ...
        <div class="h-full flex flex-col">
            ...
            <nav class="flex-1 overflow-y-auto p-3">
                <div class="space-y-1">
                    ...
                    <a href="{{ route('yer-sotuvlar.index') }}"
                        class="nav-item flex items-center space-x-3 px-3 py-2.5 rounded-lg {{ request()->routeIs('yer-sotuvlar.index') ? 'active' : '' }}">
                        <svg class="w-5 h-5 {{ request()->routeIs('yer-sotuvlar.index') ? 'text-white' : 'text-gray-600' }}"
                            fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
                        </svg>
                        <span
                            class="nav-text text-sm font-medium {{ request()->routeIs('yer-sotuvlar.index') ? 'text-white' : 'text-gray-700' }}">Ер
                            мониторинг</span>
                    </a>

                    <a href="{{ route('yer-sotuvlar.yigma') }}"
                        class="nav-item flex items-center space-x-3 px-3 py-2.5 rounded-lg {{ request()->routeIs('yer-sotuvlar.yigma') ? 'active' : '' }}">
                        <svg class="w-5 h-5 {{ request()->routeIs('yer-sotuvlar.yigma') ? 'text-white' : 'text-gray-600' }}"
                            fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
                        </svg>
                        <span
                            class="nav-text text-sm font-medium {{ request()->routeIs('yer-sotuvlar.yigma') ? 'text-white' : 'text-gray-700' }}">Тўлов
                            мониторинг</span>
                    </a>
                    <a href="{{ route('yer-sotuvlar.svod3') }}"
                        ...
                        <svg class="w-5 h-5 {{ request()->routeIs('yer-sotuvlar.svod3') ? 'text-white' : 'text-gray-600' }}"
                            fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <span
                            ...
                            тўлаш мониторинги</span>
                    </a>

                    <a href="{{ route('yer-sotuvlar.list') }}"
                        class="nav-item flex items-center space-x-3 px-3 py-2.5 rounded-lg {{ request()->routeIs('yer-sotuvlar.list') ? 'active' : '' }}">
                        <svg class="w-5 h-5 {{ request()->routeIs('yer-sotuvlar.list') ? 'text-white' : 'text-gray-600' }}"
                            fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <a href="{{ route('yer-sotuvlar.fin-xisobot') }}"
                        class="nav-item flex items-center justify-between px-3 py-2.5 rounded-lg {{ request()->routeIs('yer-sotuvlar.fin-xisobot') ? 'active' : '' }}">
                        ...
                        <div class="flex items-center space-x-3">
                            ...
                            <span
                                class="nav-text text-sm font-medium {{ request()->routeIs('yer-sotuvlar.fin-xisobot') ? 'text-white' : 'text-gray-700' }}">
                                Молиявий Хисобот
                            </span>
                        </div>
                    ...
                    <a href="{{ route('qoldiq.index') }}"
                        class="nav-item flex items-center space-x-3 px-3 py-2.5 rounded-lg {{ request()->routeIs('qoldiq.index') ? 'active' : '' }}">
                        <svg class="w-5 h-5 {{ request()->routeIs('qoldiq.index') ? 'text-white' : 'text-gray-600' }}"
                            fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                        </svg>
                        <span
                            class="nav-text text-sm font-medium {{ request()->routeIs('qoldiq.index') ? 'text-white' : 'text-gray-700' }}">Қолдиқ</span>
                    </a>


                    <!-- Full Export Button (Complete Excel Structure) -->

                    <a href="{{ route('export.full') }}"
                        class="nav-item flex items-center space-x-3 px-3 py-2.5 rounded-lg {{ request()->routeIs('export.full') ? 'active' : '' }}">
                        <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                        </svg>
                        <span
                            class="nav-text text-sm font-medium {{ request()->routeIs('export.full') ? 'text-white' : 'text-gray-700' }}">To'liq
                            eksport (Grafik bilan)</span>
                    </a>


                    <a href="{{ route('export.summary') }}"
                        class="nav-item flex items-center space-x-3 px-3 py-2.5 rounded-lg {{ request()->routeIs('export.summary') ? 'active' : '' }}">
                        <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                        </svg>
                        <span
                            class="nav-text text-sm font-medium {{ request()->routeIs('export.summary') ? 'text-white' : 'text-gray-700' }}">Qisqacha
                            hisobot</span>
                    </a>
                </div>
            ...
            @auth
                <div class="p-3 border-t border-gray-200">
                    <form method="POST" action="{{ route('logout') }}" id="logoutForm">
                        @csrf
                        <button type="submit"
                            class="nav-item w-full flex items-center space-x-3 px-3 py-2.5 rounded-lg hover:bg-red-50 text-red-600">
            ...
            <div class="p-4 border-t border-gray-200">
                <div class="flex items-center space-x-3">
                    ...
                    <div class="nav-text">
                        <p class="text-xs font-semibold text-gray-900">{{ now()->format('d.m.Y') }}</p>
            ...
            <div class="flex items-center justify-between">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-500">
                        ...
                        @if ($latestLotDate)
                            <span class="text-emerald-600 font-medium">| Лот:
                                {{ \Carbon\Carbon::parse($latestLotDate)->format('d.m.Y') }}</span>
                        @endif
                        @if ($latestPaymentDate)
                            <span class="text-blue-600 font-medium">| Тўлов:
                                {{ \Carbon\Carbon::parse($latestPaymentDate)->format('d.m.Y') }}</span>
                        @endif
                    </p>
                </div>
