    ...
    <div class="min-h-screen bg-gray-50 py-6 px-4 sm:px-6 lg:px-8">
        ...
        <div class="mx-auto mb-6">
            <div class="bg-white shadow-sm rounded-lg overflow-hidden border border-gray-200">
                ...
                <form method="GET" action="{{ route('yer-sotuvlar.list') }}" class="bg-gray-50 px-6 py-4 border-b border-gray-200">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                        ...
                        <div>
                            ...
                            <input type="number"
                                   name="narx_from"
                                   class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                                   value="{{ request('narx_from') }}"
                                   step="0.01"
                                   placeholder="Мин нарх">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text"
                                   ...
                                   class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                                   value="{{ request('asos') }}"
                                   placeholder="Асос қидириш">
                        </div>

                        <!-- Tolov Turi Filter -->
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Тўлов тури</label>
                            <select name="tolov_turi" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                                <option value="">Барчаси</option>
                        ...
                        <div>
                            ...
                            <select name="sort" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                                <option value="auksion_sana" {{ request('sort') == 'auksion_sana' ? 'selected' : '' }}>Аукцион санаси</option>
                                <option value="sotilgan_narx" {{ request('sort') == 'sotilgan_narx' ? 'selected' : '' }}>Сотилган нарх</option>
                                <option value="boshlangich_narx" {{ request('sort') == 'boshlangich_narx' ? 'selected' : '' }}>Бошланғич нарх</option>
                    ...
                    <div class="flex flex-wrap gap-3">
                        ...
                        @if (request('narx_from') || request('narx_to'))
                            <div class="inline-flex items-center bg-white border border-gray-300 rounded-md px-3 py-2 text-sm">
                                ...
                                <span class="ml-1 font-semibold text-gray-900">
                                    {{ request('narx_from') ? number_format(request('narx_from')) : '0' }} - {{ request('narx_to') ? number_format(request('narx_to')) : '∞' }}
                                </span>
                            </div>
                        @endif
                ...
                <div class="bg-white px-6 py-5">
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                        ...
                        <div class="text-center p-4 bg-gray-50 rounded-lg border border-gray-200">
                            <div class="text-3xl font-bold text-gray-800">{{ number_format($statistics['boshlangich_narx'] / 1000000000, 1) }}</div>
                        ...
                        <thead class="bg-gray-700">
                            <tr>
                                ...
                                @foreach($columns as $field => $label)
                                    ...
                                    <th scope="col" class="px-4 py-3 text-left text-xs font-medium text-white uppercase tracking-wider cursor-pointer hover:bg-gray-600 transition-colors">
                                ...
                                <th scope="col" class="px-4 py-3 text-left text-xs font-medium text-white uppercase tracking-wider">Телефон</th>
                                <th scope="col" class="px-4 py-3 text-left text-xs font-medium text-white uppercase tracking-wider">Тўлов</th>
                                <th scope="col" class="px-4 py-3 text-left text-xs font-medium text-white uppercase tracking-wider">Ҳолат</th>
                            </tr>
                        </thead>
                        <tbody class="bg-white divide-y divide-gray-200">
                            @forelse($yerlar as $yer)
                                <tr class="hover:bg-gray-50 transition-colors">
                                    ...
                                    <td class="px-4 py-4 text-sm text-gray-900 max-w-xs truncate" title="{{ $yer->manzil }}">
                                    ...
                                    <td class="px-4 py-4 text-sm text-gray-900 max-w-xs truncate" title="{{ $yer->golib_nomi }}">
                                    ...
                                    <td class="px-4 py-4 text-sm text-gray-600 max-w-sm truncate" title="{{ $yer->holat }}">
