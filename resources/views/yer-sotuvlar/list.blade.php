...
<div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-3 p-4 bg-gray-50 border-b border-gray-200">
        <div class="text-center p-3 bg-white rounded border border-gray-200">
            ...
            <div class="text-lg font-bold text-gray-900">{{ number_format($statistics['total_lots']) }}</div>
        </div>
        <div class="text-center p-3 bg-white rounded border border-gray-200">
            <div class="text-xs text-gray-600">Умумий майдон</div>
            <div class="text-lg font-bold text-gray-900">{{ number_format($statistics['total_area'], 2) }} га</div>
        </div>
        <div class="text-center p-3 bg-white rounded border border-gray-200">
            <div class="text-xs text-gray-600">Бошланғич нархи</div>
            <div class="text-lg font-bold text-gray-900">{{ number_format($statistics['boshlangich_narx'], 2) }} млрд</div>
        </div>
        <div class="text-center p-3 bg-white rounded border border-gray-200">
            <div class="text-xs text-gray-600">Сотилган нархи</div>
            <div class="text-lg font-bold text-gray-900">{{ number_format($statistics['total_price'], 2) }} млрд</div>
        </div>
        ...
        <div class="text-center p-3 bg-white text-gray-600 rounded font-bold">
            ...
            {{ number_format((($statistics['shartnoma_summasi'] + $statistics['golib_tolagan']) - $statistics['auksion_harajati']), 2) }} млрд
        </div>
        <div class="text-center p-3 bg-white text-gray-600 rounded font-bold">
            <div class="text-xs">Шартнома графиги б-ча тўлов</div>
            <div class="text-lg font-bold">{{ number_format($statistics['shartnoma_summasi'], 2) }} млрд</div>
        </div>
        ...
        <div class="text-center p-3 bg-white text-gray-600 rounded font-bold">
            ...
            {{ number_format((($statistics['shartnoma_summasi'] + $statistics['golib_tolagan']) - ($statistics['fakt_tolangan'] + $statistics['auksion_harajati'])) / 1000000000, 2) }} млрд
        </div>
    </div>
</div>
