        ...
        <div class="bg-white rounded-xl shadow-2xl overflow-hidden border-t-4 border-blue-600">
            <div class="px-6 py-5 bg-gradient-to-r from-blue-50 to-slate-50 border-b border-slate-200">
                <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    ...
                    <a href="{{ route('yer-sotuvlar.fin-xisobot') }}" class="inline-flex items-center justify-center px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors font-semibold">
                        Орқага
                    </a>
                </div>
            </div>
            ...
            <div class="overflow-x-auto">
                <table class="w-full border-collapse">
                    ...
                    <tbody>
                        ...
                        @empty
                            <tr>
                                <td colspan="9" class="border border-slate-300 px-4 py-6 text-center text-slate-600">
