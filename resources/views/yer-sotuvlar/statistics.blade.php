                            ...
                            <tbody class="bg-white">
                                ...
                                <tr
                                    ...
                                    <td class="border border-slate-400 px-3 py-3 text-right font-bold text-red-700">
                                        {{ number_format(($statistics['jami']['jami']['tushadigan_mablagh'] - $statistics['jami']['jami_tushgan_yigindi']) / 1000000000, 1) }}
                                    </td>

                                    <!-- Col 11: Foizda -->
                                    <td class="border border-slate-400 px-3 py-3 text-right font-bold text-slate-900">
                                        {{ $statistics['jami']['jami']['tushadigan_mablagh'] > 0 ? number_format(($statistics['jami']['jami_tushgan_yigindi'] / $statistics['jami']['jami']['tushadigan_mablagh']) * 100, 1) : 0 }}%
                                    </td>
                                    ...
                                    <!-- Col 29: Bolib tushgan -->
                                    <td class="border border-slate-400 px-3 py-3 text-right font-bold text-blue-900">
                                        {{ number_format($statistics['jami']['bolib_tushgan'] / 1000000000, 1) }}</td>

                                    <!-- Col 30: Bolib qoldiq -->
                                    <td class="border border-slate-400 px-3 py-3 text-right font-bold text-red-700">
                                        {{ number_format(($statistics['jami']['bolib_tushadigan'] - $statistics['jami']['bolib_tushgan']) / 1000000000, 1) }}
                                    </td>

                                    <!-- Col 31: Bolib foiz -->
                                    <td class="border border-slate-400 px-3 py-3 text-right font-bold text-slate-900">
                                        {{ $statistics['jami']['bolib_tushadigan'] > 0 ? number_format(($statistics['jami']['bolib_tushgan'] / $statistics['jami']['bolib_tushadigan']) * 100, 1) : 0 }}%
                                    </td>
...
<td class="border border-slate-400 px-3 py-3 text-right font-bold text-slate-900">
    {{ number_format(($statistics['jami']['mulk_qabul']['total_auksion_mablagh_muddatli_emas'] ?? 0) / 1000000000, 1) }}
</td>
                                </tr>
                                ...
                                @foreach ($statistics['tumanlar'] as $index => $tuman)
                                    <tr
                                        ...
                                        <td class="border border-slate-400 px-3 py-3 text-right text-blue-700 font-medium">
                                            {{ number_format($tuman['jami_tushgan_yigindi'] / 1000000000, 1) }}</td>

                                        <!-- Col 10: Jami qoldiq -->
                                        <td class="border border-slate-400 px-3 py-3 text-right text-red-700 font-medium">
                                            {{ number_format(($tuman['jami']['tushadigan_mablagh'] - $tuman['jami_tushgan_yigindi']) / 1000000000, 1) }}
                                        </td>

                                        <!-- Col 11: Jami foiz -->
                                        <td class="border border-slate-400 px-3 py-3 text-right text-slate-700">
                                            {{ $tuman['jami']['tushadigan_mablagh'] > 0 ? number_format(($tuman['jami_tushgan_yigindi'] / $tuman['jami']['tushadigan_mablagh']) * 100, 1) : 0 }}%
                                        </td>
                                        ...
                                        <!-- Col 29: Bolib tushgan -->
                                        <td class="border border-slate-400 px-3 py-3 text-right text-blue-700 font-medium">
                                            {{ number_format($tuman['bolib_tushgan'] / 1000000000, 1) }}</td>

                                        <!-- Col 30: Bolib qoldiq -->
                                        <td class="border border-slate-400 px-3 py-3 text-right text-red-700 font-medium">
                                            {{ number_format(($tuman['bolib_tushadigan'] - $tuman['bolib_tushgan']) / 1000000000, 1) }}
                                        </td>

                                        <!-- Col 31: Bolib foiz -->
                                        <td class="border border-slate-400 px-3 py-3 text-right text-slate-700">
                                            {{ $tuman['bolib_tushadigan'] > 0 ? number_format(($tuman['bolib_tushgan'] / $tuman['bolib_tushadigan']) * 100, 1) : 0 }}%
                                        </td>
