                            ...
                            <tbody class="bg-white">
                                ...
                                <tr
                                    ...
                                    <td class="border border-slate-400 px-3 py-3 text-right font-bold text-slate-900">
                                        <a href="{{ route('yer-sotuvlar.list', ['include_all' => 'false', 'auksion_sana_from' => $dateFilters['auksion_sana_from'], 'auksion_sana_to' => $dateFilters['auksion_sana_to']]) }}"
                                    ...
                                    <td class="border border-slate-400 px-3 py-3 text-right font-bold text-slate-900">
                                        <a href="{{ route('yer-sotuvlar.list', ['holat' => 'Ishtirokchi roziligini kutish jarayonida', 'include_all' => 'false', 'auksion_sana_from' => $dateFilters['auksion_sana_from'], 'auksion_sana_to' => $dateFilters['auksion_sana_to']]) }}"
                                    ...
                                    <tr
                                        ...
                                        <td class="border border-slate-400 px-3 py-3 text-right text-slate-700">
                                            @if ($tuman['jami']['soni'] > 0)
                                                <a href="{{ route('yer-sotuvlar.list', ['tuman' => $tuman['tuman'], 'include_all' => 'false', 'auksion_sana_from' => $dateFilters['auksion_sana_from'], 'auksion_sana_to' => $dateFilters['auksion_sana_to']]) }}"
                                        ...
                                        <td class="border border-slate-400 px-3 py-3 text-right text-slate-700">
                                            @if (($tuman['mulk_qabul']['total_records'] ?? 0) > 0)
                                                <a href="{{ route('yer-sotuvlar.list', ['tuman' => $tuman['tuman'], 'holat' => 'Ishtirokchi roziligini kutish jarayonida', 'include_all' => 'false', 'auksion_sana_from' => $dateFilters['auksion_sana_from'], 'auksion_sana_to' => $dateFilters['auksion_sana_to']]) }}"
