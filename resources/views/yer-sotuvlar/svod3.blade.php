...
@section('title', 'DEBUG: Step-by-Step Formula Calculation')

@section('content')
    <div class="container-fluid py-4">

        {{-- MINI DEBUG TABLE - STEP BY STEP FORMULA --}}
            ...
            <div class="card-body">
                ...
                <div class="card">
                    <div class="card-header bg-primary text-white text-center">
                        <h5 class="mb-0 text-dark" style="color: #000; font-weight: bold;">Тошкент шаҳрида аукцион савдоларида
                            бўлиб тўлаш шарти билан сотилган ер участкалари тўғрисида</h5>
                            ...
                            <table class="table table-bordered table-sm mb-0" style="font-size: 9px;">
                                ...
                                <tbody>
                                    ...
                                    <tr class="table-warning fw-bold" style="font-weight: bold">
                                        ...
                                        <td class="text-end">
                                            {{ number_format($statistics['jami']['narhini_bolib']['maydoni'], 2) }}</td>
                                        <td class="text-end">
                                        ...
                                        <td class="text-end">
                                            {{ number_format($statistics['jami']['toliq_tolanganlar']['maydoni'], 2) }}</td>
                                        <td class="text-end">
                                        ...
                                        <td class="text-end">
                                            {{ number_format($statistics['jami']['nazoratdagilar']['maydoni'], 2) }}</td>
                                        <td class="text-end">
                                        ...
                                        <td class="text-end">
                                            {{ number_format($statistics['jami']['grafik_ortda']['maydoni'], 2) }}</td>
                                        <td class="text-end">
                                    ...
                                    @foreach ($statistics['tumanlar'] as $index => $tuman)
                                        <tr>
                                            ...
                                            <td class="text-end">{{ number_format($tuman['narhini_bolib']['maydoni'], 2) }}
                                            </td>
                                            <td class="text-end">
                                            ...
                                            <td class="text-end">
                                                ...
                                                @else
                                                    {{ $tuman['toliq_tolanganlar']['soni'] ?? 0 }}
                                                @endif
                                            </td>
                                            <td class="text-end">
                                                {{ number_format($tuman['toliq_tolanganlar']['maydoni'] ?? 0, 2) }}</td>
                                            <td class="text-end">
                                            ...
                                            <td class="text-end">
                                                ...
                                                @else
                                                    {{ $tuman['nazoratdagilar']['soni'] ?? 0 }}
                                                @endif
                                            </td>
                                            <td class="text-end">
                                                {{ number_format($tuman['nazoratdagilar']['maydoni'] ?? 0, 2) }}</td>
                                            <td class="text-end">
                                            ...
                                            <td class="text-end">
                                                ...
                                                @else
                                                    {{ $tuman['grafik_ortda']['soni'] ?? 0 }}
                                                @endif
                                            </td>
                                            <td class="text-end">
                                                {{ number_format($tuman['grafik_ortda']['maydoni'] ?? 0, 2) }}</td>
                                            <td class="text-end">
