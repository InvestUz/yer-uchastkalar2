            ...
            <div class="space-y-3">
                ...
                <div class="flex items-center justify-between p-3 bg-green-50 rounded-lg">
                    <div class="flex items-center gap-3">
                        ...
                        <span class="font-semibold text-slate-800">{{ $stat['tuman'] }}</span>
                    </div>
                    <span class="text-lg font-bold" style="color: rgb(29, 78, 216);">{{ number_format($stat['percentage'], 1) }}%</span>
                </div>
                @endforeach
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-lg p-6">
            ...
            <div class="space-y-3">
                ...
                <div class="flex items-center justify-between p-3 bg-red-50 rounded-lg">
                    ...
                    <span class="text-lg font-bold text-red-600">{{ number_format($stat['percentage'], 1) }}%</span>
                </div>
                @endforeach
            </div>
        </div>
...
new Chart(overdueCtx, {
    type: 'bar',
    data: {
        labels: {!! json_encode($chartData['overdue']['labels']) !!},
        datasets: [{
            label: 'Ортда қолган маблағ (млрд)',
            data: {!! json_encode($chartData['overdue']['amounts']) !!},
