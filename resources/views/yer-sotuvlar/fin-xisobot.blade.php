                                ...
                                @else
                                    <tr class="bg-gradient-to-r from-amber-100 via-yellow-100 to-amber-100 border-y-2 border-amber-400">
                                        ...
                                        <td class="total-amount-col border border-slate-300 px-2 py-1 text-right font-bold text-slate-900">
                                            <a href="{{ route('yer-sotuvlar.fin-xisobot.details') }}" class="block text-blue-700 hover:text-blue-900 hover:underline">
                                        ...
                                        @foreach($paymentCategories as $category => $value)
                                            <td class="border border-slate-300 px-2 py-1 text-right font-bold text-slate-900">
                                                ...
                                                @if($catTotal > 0)
                                                    <a href="{{ route('yer-sotuvlar.fin-xisobot.details', ['category' => $category]) }}" class="block text-blue-700 hover:text-blue-900 hover:underline text-right">
                                    ...
                                    @foreach($districtData as $district => $values)
                                        <tr class="hover:bg-blue-50 transition-colors duration-150 bg-white">
                                            ...
                                            <td class="total-amount-col border border-slate-300 px-2 py-1 text-right text-slate-700">
                                                ...
                                                @if($districtTotal > 0)
                                                    <a href="{{ route('yer-sotuvlar.fin-xisobot.details', ['district' => $district]) }}" class="block text-blue-700 hover:text-blue-900 hover:underline text-right">
                                            ...
                                            @foreach($paymentCategories as $category => $value)
                                                <td class="border border-slate-300 px-2 py-1 text-right text-slate-700">
                                                    ...
                                                    @if($cellAmount > 0)
                                                        <a href="{{ route('yer-sotuvlar.fin-xisobot.details', ['district' => $district, 'category' => $category]) }}" class="block text-blue-700 hover:text-blue-900 hover:underline text-right">
