    ...
    <form action="{{ route('yer-sotuvlar.update', $yer->lot_raqami) }}" method="POST" class="space-y-6">
        ...
        <div class="bg-white rounded-xl shadow-lg p-6 border-l-4 border-indigo-500">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div>
                    ...
                    <input type="number" step="0.01" name="mahalliy_byudjet_tushadigan" value="{{ old('mahalliy_byudjet_tushadigan', $yer->mahalliy_byudjet_tushadigan) }}" 
                           class="w-full px-4 py-2.5 border-2 border-slate-300 rounded-lg focus:ring-4 focus:ring-blue-200 focus:border-blue-500 transition-all">
                </div>
                ...
                <div>
                    ...
                    <input type="number" step="0.01" name="jamgarma_tushadigan" value="{{ old('jamgarma_tushadigan', $yer->jamgarma_tushadigan) }}" 
                           class="w-full px-4 py-2.5 border-2 border-slate-300 rounded-lg focus:ring-4 focus:ring-blue-200 focus:border-blue-500 transition-all">
                </div>
                ...
                <div>
                    ...
                    <input type="number" step="0.01" name="yangi_oz_direksiya_tushadigan" value="{{ old('yangi_oz_direksiya_tushadigan', $yer->yangi_oz_direksiya_tushadigan) }}" 
                           class="w-full px-4 py-2.5 border-2 border-slate-300 rounded-lg focus:ring-4 focus:ring-blue-200 focus:border-blue-500 transition-all">
                </div>
                ...
                <div>
                    ...
                    <input type="number" step="0.01" name="shayxontohur_tushadigan" value="{{ old('shayxontohur_tushadigan', $yer->shayxontohur_tushadigan) }}" 
                           class="w-full px-4 py-2.5 border-2 border-slate-300 rounded-lg focus:ring-4 focus:ring-blue-200 focus:border-blue-500 transition-all">
                </div>
                ...
                <div>
                    ...
                    <input type="number" step="0.01" name="yangi_hayot_industrial_park_tushadigan" value="{{ old('yangi_hayot_industrial_park_tushadigan', $yer->yangi_hayot_industrial_park_tushadigan) }}" 
                           class="w-full px-4 py-2.5 border-2 border-slate-300 rounded-lg focus:ring-4 focus:ring-blue-200 focus:border-blue-500 transition-all">
                </div>
                ...
                <div>
                    ...
                    <input type="number" step="0.01" name="ksz_direksiyalari_tushadigan" value="{{ old('ksz_direksiyalari_tushadigan', $yer->ksz_direksiyalari_tushadigan) }}" 
                           class="w-full px-4 py-2.5 border-2 border-slate-300 rounded-lg focus:ring-4 focus:ring-blue-200 focus:border-blue-500 transition-all">
                </div>
                ...
                <div>
                    ...
                    <input type="number" step="0.01" name="toshkent_city_direksiya_tushadigan" value="{{ old('toshkent_city_direksiya_tushadigan', $yer->toshkent_city_direksiya_tushadigan) }}" 
                           class="w-full px-4 py-2.5 border-2 border-slate-300 rounded-lg focus:ring-4 focus:ring-blue-200 focus:border-blue-500 transition-all">
                </div>
                ...
                <div>
                    ...
                    <input type="number" step="0.01" name="tuman_byudjeti_tushadigan" value="{{ old('tuman_byudjeti_tushadigan', $yer->tuman_byudjeti_tushadigan) }}" 
                           class="w-full px-4 py-2.5 border-2 border-slate-300 rounded-lg focus:ring-4 focus:ring-blue-200 focus:border-blue-500 transition-all">
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-lg p-6 border-l-4 border-teal-500">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div>
                    <label class="block text-sm font-semibold text-slate-700 mb-2">Маҳаллий бюджет</label>
                    <input type="number" step="0.01" name="mahalliy_byudjet_taqsimlangan" value="{{ old('mahalliy_byudjet_taqsimlangan', $yer->mahalliy_byudjet_taqsimlangan) }}" 
                           class="w-full px-4 py-2.5 border-2 border-slate-300 rounded-lg focus:ring-4 focus:ring-blue-200 focus:border-blue-500 transition-all">
                </div>
                ...
                <div>
                    <label class="block text-sm font-semibold text-slate-700 mb-2">Жамғарма</label>
                    <input type="number" step="0.01" name="jamgarma_taqsimlangan" value="{{ old('jamgarma_taqsimlangan', $yer->jamgarma_taqsimlangan) }}" 
                           class="w-full px-4 py-2.5 border-2 border-slate-300 rounded-lg focus:ring-4 focus:ring-blue-200 focus:border-blue-500 transition-all">
                </div>
                ...
                <div>
                    <label class="block text-sm font-semibold text-slate-700 mb-2">Янги Ўзбекистон дир.</label>
                    <input type="number" step="0.01" name="yangi_oz_direksiya_taqsimlangan" value="{{ old('yangi_oz_direksiya_taqsimlangan', $yer->yangi_oz_direksiya_taqsimlangan) }}" 
                           class="w-full px-4 py-2.5 border-2 border-slate-300 rounded-lg focus:ring-4 focus:ring-blue-200 focus:border-blue-500 transition-all">
                </div>
                ...
                <div>
                    <label class="block text-sm font-semibold text-slate-700 mb-2">Шайхонтоҳур</label>
                    <input type="number" step="0.01" name="shayxontohur_taqsimlangan" value="{{ old('shayxontohur_taqsimlangan', $yer->shayxontohur_taqsimlangan) }}" 
                           class="w-full px-4 py-2.5 border-2 border-slate-300 rounded-lg focus:ring-4 focus:ring-blue-200 focus:border-blue-500 transition-all">
                </div>
                ...
                <div>
                    <label class="block text-sm font-semibold text-slate-700 mb-2">Янги Ҳаёт Инд. Парк</label>
                    <input type="number" step="0.01" name="yangi_hayot_industrial_park_taqsimlangan" value="{{ old('yangi_hayot_industrial_park_taqsimlangan', $yer->yangi_hayot_industrial_park_taqsimlangan) }}" 
                           class="w-full px-4 py-2.5 border-2 border-slate-300 rounded-lg focus:ring-4 focus:ring-blue-200 focus:border-blue-500 transition-all">
                </div>
                ...
                <div>
                    <label class="block text-sm font-semibold text-slate-700 mb-2">КСЗ дирекциялари</label>
                    <input type="number" step="0.01" name="ksz_direksiyalari_taqsimlangan" value="{{ old('ksz_direksiyalari_taqsimlangan', $yer->ksz_direksiyalari_taqsimlangan) }}" 
                           class="w-full px-4 py-2.5 border-2 border-slate-300 rounded-lg focus:ring-4 focus:ring-blue-200 focus:border-blue-500 transition-all">
                </div>
                ...
                <div>
                    <label class="block text-sm font-semibold text-slate-700 mb-2">Тошкент Сити дир.</label>
                    <input type="number" step="0.01" name="toshkent_city_direksiya_taqsimlangan" value="{{ old('toshkent_city_direksiya_taqsimlangan', $yer->toshkent_city_direksiya_taqsimlangan) }}" 
                           class="w-full px-4 py-2.5 border-2 border-slate-300 rounded-lg focus:ring-4 focus:ring-blue-200 focus:border-blue-500 transition-all">
                </div>
                ...
                <div>
                    <label class="block text-sm font-semibold text-slate-700 mb-2">Туман бюджети</label>
                    <input type="number" step="0.01" name="tuman_byudjeti_taqsimlangan" value="{{ old('tuman_byudjeti_taqsimlangan', $yer->tuman_byudjeti_taqsimlangan) }}" 
                           class="w-full px-4 py-2.5 border-2 border-slate-300 rounded-lg focus:ring-4 focus:ring-blue-200 focus:border-blue-500 transition-all">
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-lg p-6 border-l-4 border-yellow-500">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div>
                    <label class="block text-sm font-semibold text-slate-700 mb-2">Маҳаллий бюджет</label>
                    <input type="number" step="0.01" name="qoldiq_mahalliy_byudjet" value="{{ old('qoldiq_mahalliy_byudjet', $yer->qoldiq_mahalliy_byudjet) }}" 
                           class="w-full px-4 py-2.5 border-2 border-slate-300 rounded-lg focus:ring-4 focus:ring-blue-200 focus:border-blue-500 transition-all">
                </div>
                ...
                <div>
                    <label class="block text-sm font-semibold text-slate-700 mb-2">Жамғарма</label>
                    <input type="number" step="0.01" name="qoldiq_jamgarma" value="{{ old('qoldiq_jamgarma', $yer->qoldiq_jamgarma) }}" 
                           class="w-full px-4 py-2.5 border-2 border-slate-300 rounded-lg focus:ring-4 focus:ring-blue-200 focus:border-blue-500 transition-all">
                </div>
                ...
                <div>
                    <label class="block text-sm font-semibold text-slate-700 mb-2">Янги Ўзбекистон дир.</label>
                    <input type="number" step="0.01" name="qoldiq_yangi_oz_direksiya" value="{{ old('qoldiq_yangi_oz_direksiya', $yer->qoldiq_yangi_oz_direksiya) }}" 
                           class="w-full px-4 py-2.5 border-2 border-slate-300 rounded-lg focus:ring-4 focus:ring-blue-200 focus:border-blue-500 transition-all">
                </div>
                ...
                <div>
                    <label class="block text-sm font-semibold text-slate-700 mb-2">Шайхонтоҳур</label>
                    <input type="number" step="0.01" name="qoldiq_shayxontohur" value="{{ old('qoldiq_shayxontohur', $yer->qoldiq_shayxontohur) }}" 
                           class="w-full px-4 py-2.5 border-2 border-slate-300 rounded-lg focus:ring-4 focus:ring-blue-200 focus:border-blue-500 transition-all">
                </div>
            </div>
        </div>
